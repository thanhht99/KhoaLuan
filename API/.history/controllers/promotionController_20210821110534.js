...
exports.createNewPromotion = asyncMiddleware(async(req, res, next) => {
    ...
    req.checkBody("startDate", "Start Date must be in correct format  !!").isISO8601().toDate();
    req.checkBody("endDate", "End Date must be in correct format  !!").isISO8601().toDate();
