...
exports.createNewPromotion = asyncMiddleware(async(req, res, next) => {
    ...
    console.log("🚀 ~ file: promotionController.js ~ line 75 ~ exports.createNewPromotion=asyncMiddleware ~ checkProduct.length", checkProduct.length)
    console.log("🚀 ~ file: promotionController.js ~ line 75 ~ exports.createNewPromotion=asyncMiddleware ~ objProducts.length", objProducts.length)
