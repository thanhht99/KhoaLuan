...
exports.createNewPromotion = asyncMiddleware(async(req, res, next) => {
            ...
            const checkProduct = products.filter((val) => {
                    ...
                    console.log("🚀 ~ file: TEST", typeof(val) const check = Product.findOne({ sku: val });
                ...
                const promotion = new Promotion({ products: checkProduct, promotion_name, promotion_desc, discount, type, startDate: convertStartDate, endDate: convertEndDate }); console.log("🚀 ~ file: promotionController.js ~ line 73 ~ exports.createNewPromotion=asyncMiddleware ~ promotion", promotion)
