...
const promotion = new Promotion({ products, promotion_name, promotion_desc, discount, type, startDate: convertStartDate, endDate: convertEndDate }); console.log("🚀 ~ file: promotionController.js ~ line 73 ~ exports.createNewPromotion=asyncMiddleware ~ promotion", promotion)
