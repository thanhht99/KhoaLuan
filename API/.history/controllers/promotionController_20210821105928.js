...
exports.createNewPromotion = asyncMiddleware(async(req, res, next) => {
    ...
    req.checkBody("startDate", "Start Date start must be in correct format yyyy:mm:dd hh:mm:ss !!").isISO8601('dd-mm-yyyy').toDate();
    req.checkBody("endDate", "Invalid End Date !!").isISO8601().toDate();
