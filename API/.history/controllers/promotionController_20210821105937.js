...
exports.createNewPromotion = asyncMiddleware(async(req, res, next) => {
    ...
    req.checkBody("startDate", "Start Date must be in correct format yyyy:mm:dd hh:mm:ss !!").isISO8601('dd-mm-yyyy').toDate();
    req.checkBody("endDate", "Invalid End Date must be in correct format yyyy:mm:dd hh:mm:ss !!").isISO8601().toDate();
    ...
    console.log("🚀 ~ file: promotionController.js ~ line 64 ~ exports.createNewPromotion=asyncMiddleware ~ Date(endDate)", Date(endDate))
